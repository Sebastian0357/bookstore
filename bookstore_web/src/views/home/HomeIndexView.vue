  ...
  <div class="up">
    ...
    <div class="container">
      <div class="row justify-content-md-center">
        ...
        <a href="" class="col-sm col-md-auto serach-tag" v-for="data in hotSearch" :key="data" @click="goToDetail(data.id)">{{ data.bookname
          }}</a>
      </div>
    </div>
  </div>
        ...
        <div class="card h-100">
          <div class="card-body">
            ...
            <div class="grid-container">
              <div class="grid-item" v-for="(data, index) in tableData" :key="index" @click="goToDetail(data.id)">
